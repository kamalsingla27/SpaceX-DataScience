...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL': 
        fig = px.pie(spacex_df, values='class', names='Launch Site', title='All Sites Success Rate')
    else:
        filtered_df =  spacex_df[spacex_df['Launch Site'] == entered_site]
        filtered_df = filtered_df.groupby(['class'])['class'].count().reset_index(name='count')

        fig = px.pie(filtered_df, names='class', values='count', title='Launch Site Success Rate')
